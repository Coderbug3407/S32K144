...
#define _ARM_Driver_USART_(n)      Driver_USART
...
typedef struct {
    system_clock_src_t clockSrc; /* Clock Source (SOSC, FIRC...) */
    uint32_t           srcFreq;  /* Clock Source Frequency (Hz) */
    uint8_t            osr;      /* Over Sampling Ratio (4-32) */
} USART_HW_CONFIG;

/*Function to set HW Config from Application */
